...
class Course(models.Model):
    ...
    language = models.ForeignKey(Language, on_delete=models.RESTRICT, related_name='courses', default=1)
    mentors = models.ForeignKey(Mentor, on_delete=models.RESTRICT, related_name='courses')
